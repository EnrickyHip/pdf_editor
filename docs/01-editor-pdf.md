...
- Permitir login com NextAuth (Credentials + senha). Usuário pode editar e exportar sem login, mas armazenamento e histórico somente com login. Registro separado com email, senha e nome opcional.
